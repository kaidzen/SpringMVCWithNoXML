...
<body>
    <div class="generic-container">
        ...
        <form:form class="form-horizontal" modelAttribute="user" method="post">
            <form:input path="id" type="hiden" id="id"/>

            <div class="row">
                <div class="form-group col-md-12">
                    <label class="col-md-3 control-label" for="firstName">First Name</label>
                    <div class="col-md-7">
                        <form:input path="firstName" type="text" id="firstName" class="form-control input-sm"/>
                        <div class="has-error">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-7">
                        <form:input path="password" type="text" id="password" class="form-control input-sm"/>
                        <div class="has-error">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-7">
                        <form:input path="email" type="text" id="email" class="form-control input-sm"/>
                        <div class="has-error">
